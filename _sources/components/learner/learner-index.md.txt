...
* **[Learners](learners.md):**  Manage local training, evaluation, and model updates on each node. They support neural networks (PyTorch, TensorFlow, Flax) and tree ensembles (XGBoost), and handle aggregator callbacks.
