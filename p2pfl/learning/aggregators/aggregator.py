...
class Aggregator:
    ...
    def add_model(self, model: LearnerStateDTO, contributors: List[str], weight: int) -> List[str]:
        """
    ...
    def wait_and_get_aggregation(self, timeout: int = Settings.AGGREGATION_TIMEOUT) -> Union[dict, None]:
        """
